...
import CreateClientView fr'om ../../views/CreateClientView';
import ClientDetailView fro'm ../../views/ClientDetailView';
import TemplatesView from ''../../views/TemplatesView';
import ContentLabView from ..'/../views/ContentLabView';
import PromptGuideView from ''../../views/PromptGuideView';
import DownloadsView fro'm../../views/DownloadsView';
