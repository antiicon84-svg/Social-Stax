    ...
    <div className="p-6 md:p-10 max-w-4xl mx-auto w-full text-white">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <div className="bg-gray-900 p-8 rounded-2xl border border-red-900/30">
          ...
          <div className="text-4xl font-bold mb-2">Pro Plan</div>
          <div className="text-gray-400 mb-6">$49 / month</div>
          <ul className="space-y-3 text-sm text-gray-300 mb-8">
            <li className="flex items-center">
              <span className="text-red-500 mr-2">✓</span> Unlimited AI Generations
            </li>
            <li className="flex items-center">
              <span className="text-red-500 mr-2">✓</span> 10 Social Profiles
            </li>
            <li className="flex items-center">
        ...
        <div className="bg-gray-900 p-8 rounded-2xl border border-gray-800">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="h-2 bg-gray-800 rounded-full overflow-hidden">
                <div className="h-full bg-red-600 w-[40%]"></div>
              </div>
            </div>
          </div>
        </div>
