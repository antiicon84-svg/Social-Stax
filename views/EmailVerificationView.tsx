  ...
  useEffect(() => {
    const verifyEmail = async () => {
      try {
        ...
        const code = new URLSearchParams(window.location.search).get('oobCode') || searchParams.get('oobCode');
        const mode = new URLSearchParams(window.location.search).get('mode') || searchParams.get('mode');
